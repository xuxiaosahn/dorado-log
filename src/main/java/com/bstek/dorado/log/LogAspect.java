...
import com.bstek.dorado.log.logger.Logger;
...
public class LogAspect implements ApplicationContextAware{
	...
	@Pointcut("@annotation(com.bstek.dorado.log.annotation.NotLog)")
	public void notLog(){}
	
	@Pointcut("within(com.bstek.dorado.log.proxy.LogProxy)")
	public void logProxy(){}
	
	@Pointcut(value = "@within(com.bstek.dorado.log.annotation.Log)")
	public void logType(){}
	
	@Pointcut(value = "@annotation(com.bstek.dorado.log.annotation.Log)")
